...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='facades_pix2pix', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--dataset_mode', type=str, default='aligned',
                            help='数据加载的mode. chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
